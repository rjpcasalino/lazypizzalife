  ...
  return (
    <div className="rw-form-wrapper">
      <Form onSubmit={onSubmit} error={props.error}>
        ...
        <TextField
          name="loginToken"
          defaultValue={props.user?.loginToken}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <Label
          ...
          errorClassName="rw-label rw-label-error"
        >
          Login token expires at
        </Label>

        <DatetimeLocalField
          name="loginTokenExpiresAt"
          defaultValue={formatDatetime(props.user?.loginTokenExpiresAt)}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
        />

        <FieldError name="loginTokenExpiresAt" className="rw-field-error" />
